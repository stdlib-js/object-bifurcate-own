...
var z=require('@stdlib/assert-is-object-like/dist'),B=require('@stdlib/assert-is-function/dist'),A=require('@stdlib/error-tools-fmtprodmsg/dist'),C=g(),D=w(),G=m(),H=y();function I(e,t,v){var i,a,r;if(!z(e))throw new TypeError(A('null3L',e));if(i={returns:"values"},arguments.length===2)r=t;else{if(a=C(i,t),a)throw a;r=v}if(!B(r))throw new TypeError(A('null3q',r));return i.returns==="values"?D(e,i,r):i.returns==="keys"?G(e,i,r):H(e,i,r)}d.exports=I
