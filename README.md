...
```javascript
bifurcateOwn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/object-bifurcate-own@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/object-bifurcate-own/tags). For example,

```javascript
bifurcateOwn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/object-bifurcate-own@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var bifurcateOwn = require( 'path/to/vendor/umd/object-bifurcate-own/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/object-bifurcate-own@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/object-bifurcate-own.svg
[npm-url]: https://npmjs.org/package/@stdlib/object-bifurcate-own

[test-image]: https://github.com/stdlib-js/object-bifurcate-own/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/object-bifurcate-own/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/object-bifurcate-own/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/object-bifurcate-own?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/object-bifurcate-own.svg
[dependencies-url]: https://david-dm.org/stdlib-js/object-bifurcate-own/main
...
[deno-url]: https://github.com/stdlib-js/object-bifurcate-own/tree/deno
[deno-readme]: https://github.com/stdlib-js/object-bifurcate-own/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/object-bifurcate-own/tree/umd
[umd-readme]: https://github.com/stdlib-js/object-bifurcate-own/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/object-bifurcate-own/tree/esm
[esm-readme]: https://github.com/stdlib-js/object-bifurcate-own/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/object-bifurcate-own/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/object-bifurcate-own/main/LICENSE
